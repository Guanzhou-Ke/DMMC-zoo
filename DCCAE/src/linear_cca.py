"""
Copy by https://github.com/VahidooX/DeepCCA/blob/master/linear_cca.py.
Note: The original class name `linear_cca` instead of LinearCCA.
"""
import numpy
...
class LinearCCA:
    ...
    def fit(self, H1, H2):
        ...
        # Arguments:
            ...
            outdim: specifies the number of new features
        # Returns
        ...
        V = V.T
        self.w[0] = numpy.dot(SigmaHat11RootInv, U[:, 0:self.outdim])
        self.w[1] = numpy.dot(SigmaHat22RootInv, V[:, 0:self.outdim])
        D = D[0:self.outdim]
